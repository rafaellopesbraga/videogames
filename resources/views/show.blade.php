...
<div class="container mx-auto px-4">
    <div class="game-details border-b border-gray-800 pb-12 flex">
        ...
        <div class="ml-12 mr-64">
            <h2 class="font-semibold text-4xl">Final Fantasy 7 Remake</h2>
            ...
            <div class="flex flex-wrap items-center mt-8">
                ...
                <div class="flex items-center ml-12">
                    <div class="w-16 h-16 bg-gray-800 rounded-full">
                        <div class="font-semibold text-xs flex justify-center items-center h-full">92%
                        </div>
                    </div>
            ...
            <p class="mt-12">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat dicta ratione eum exercitationem
                voluptas provident velit, ipsa commodi nulla, optio aspernatur, aliquam distinctio molestiae omnis quia
                assumenda nihil labore tempora suscipit. Nostrum impedit fugiat animi mollitia? Fugit tempora
                repellendus nulla ad asperiores voluptas quidem deserunt obcaecati totam odio, voluptates quam.
            </p>
